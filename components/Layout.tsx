        ...
        <div className="p-5 border-b">
          <div className="flex items-center justify-between">
            <div className="text-left">
              <p className="text-[10px] font-bold text-blue-400 uppercase leading-none mb-1"> TRƯỜNG TH TRẦN ĐẠI NGHĨA</p>
              <h1 className="text-[11px] font-black text-blue-800 leading-tight">PHƯỜNG HOÀ XUÂN</h1>
